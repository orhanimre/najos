    ...
    const emailHTML = `
      ...
      <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f4f4f4;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
          <!-- Header -->
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #ffffff !important; padding: 30px 20px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px; font-weight: 700; color: #ffffff !important;">🏡 Nuevo Registro</h1>
            <div style="margin-top: 12px; font-size: 18px; font-weight: 600; color: #ffffff !important;">${data.cabana}</div>
          </div>
          
          <!-- Admin Button -->
          <div style="padding: 20px; text-align: center; background: #2d3748;">
